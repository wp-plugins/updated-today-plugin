...
if ( is_admin() ) {
	...
	register_uninstall_hook( 'updated-today-plugin/updated-today.php', 'uninstall_settings_ut' );
...
function updated_menu() {
	add_options_page( 'Updated Today', 'Updated Today', 'administrator', 'updated-today-plugin', 'updated_menu_options' );
}
...
function pre_register_settings_ut() {
...
function uninstall_settings_ut() {
	// Delete options from db on deactivate
